...
{form name="frmDominiosConsult" method="get"}

   {tools_barstandardsp type="Button" reference_id =100 
                        form_name="frmDominiosConsult"
                        commands="vc2CmdDefaultDominios,vc2CmdShowByIdDominios,vc2CmdDeleteDominios,default,vc2CmdHelpDominios"
...
<table border=0  cellpadding=0 align="center" class=adminlist width=100%>
	...
	<tr>
		<td>{consult_table_referenciasp type="LIST" 
                                        ...
                                        llaves="DOM_ID"
                                        form_name="frmDominiosConsult"
                                        command="vc2CmdShowListDominios"     
                                        command_showbyid="vc2CmdShowByIdDominios"
                                        DataGateway="dominios"
                                        filter="DOM_ID,DOM__NOMBRE,DOM_USO"
                                        titulos="DOM_ID,DOM__NOMBRE,DOM_USO"
