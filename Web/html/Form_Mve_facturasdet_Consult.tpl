...
{form name="frmMve_facturasdetConsult" method="get"}

   {tools_barstandardsp type="Button" reference_id =100 
                        form_name="frmMve_facturasdetConsult"
                        commands="vc2CmdDefaultMve_facturasdet,vc2CmdShowByIdMve_facturasdet,vc2CmdDeleteMve_facturasdet,default,vc2CmdHelpMve_facturasdet"
...
<table border=0  cellpadding=0 align="center" class=adminlist width=100%>
	...
	<tr>
		<td>{consult_table_referenciasp type="LIST" 
                                        table_name="mve_facturasdet"
                                        llaves="FDE_ID"
                                        form_name="frmMve_facturasdetConsult"
                                        command="vc2CmdShowListMve_facturasdet"     
                                        command_showbyid="vc2CmdShowByIdMve_facturasdet"
                                        DataGateway="mve_facturasdet"
                                        filter="FDE_ID,FDE_CANTIDAD,FDE_PRECIOUNITA,FAC_ID,PDU_ID,PPM_ID"
                                        titulos="FDE_ID,FDE_CANTIDAD,FDE_PRECIOUNITA,FAC_ID,PDU_ID,PPM_ID"
