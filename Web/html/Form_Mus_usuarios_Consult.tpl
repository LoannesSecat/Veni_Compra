...
{form name="frmMus_usuariosConsult" method="get"}

   {tools_barstandardsp type="Button" reference_id =100 
                        form_name="frmMus_usuariosConsult"
                        commands="vc2CmdDefaultMus_usuarios,vc2CmdShowByIdMus_usuarios,vc2CmdDeleteMus_usuarios,default,vc2CmdHelpMus_usuarios"
...
<table border=0  cellpadding=0 align="center" class=adminlist width=100%>
	...
	<tr>
		<td>{consult_table_referenciasp type="LIST" 
                                        table_name="mus_usuarios"
                                        llaves="USU_ID"
                                        form_name="frmMus_usuariosConsult"
                                        command="vc2CmdShowListMus_usuarios"     
                                        command_showbyid="vc2CmdShowByIdMus_usuarios"
                                        DataGateway="mus_usuarios"
                                        filter="USU_ID,USU_NOMBRE,USU_APELLIDO,USU_FECHA_NACI,USU_DIRECCION,USU_EMAIL,USU_CELULAR,USU_CONTRASENA,SUB_SEXO,ROL_ID"
                                        titulos="USU_ID,USU_NOMBRE,USU_APELLIDO,USU_FECHA_NACI,USU_DIRECCION,USU_EMAIL,USU_CELULAR,USU_CONTRASENA,SUB_SEXO,ROL_ID"
