...
{form name="frmMus_comanperConsult" method="get"}

   {tools_barstandardsp type="Button" reference_id =100 
                        form_name="frmMus_comanperConsult"
                        commands="vc2CmdDefaultMus_comanper,vc2CmdShowByIdMus_comanper,vc2CmdDeleteMus_comanper,default,vc2CmdHelpMus_comanper"
...
<table border=0  cellpadding=0 align="center" class=adminlist width=100%>
	...
	<tr>
		<td>{consult_table_referenciasp type="LIST" 
                                        table_name="mus_comanper"
                                        llaves="COP_ID"
                                        form_name="frmMus_comanperConsult"
                                        command="vc2CmdShowListMus_comanper"     
                                        command_showbyid="vc2CmdShowByIdMus_comanper"
                                        DataGateway="mus_comanper"
                                        filter="COP_ID,COP_NOMBRE"
                                        titulos="COP_ID,COP_NOMBRE"
