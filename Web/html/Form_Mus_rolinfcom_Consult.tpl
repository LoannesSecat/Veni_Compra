...
{form name="frmMus_rolinfcomConsult" method="get"}

   {tools_barstandardsp type="Button" reference_id =100 
                        form_name="frmMus_rolinfcomConsult"
                        commands="vc2CmdDefaultMus_rolinfcom,vc2CmdShowByIdMus_rolinfcom,vc2CmdDeleteMus_rolinfcom,default,vc2CmdHelpMus_rolinfcom"
...
<table border=0  cellpadding=0 align="center" class=adminlist width=100%>
	...
	<tr>
		<td>{consult_table_referenciasp type="LIST" 
                                        table_name="mus_rolinfcom"
                                        llaves="RIC_ID"
                                        form_name="frmMus_rolinfcomConsult"
                                        command="vc2CmdShowListMus_rolinfcom"     
                                        command_showbyid="vc2CmdShowByIdMus_rolinfcom"
                                        DataGateway="mus_rolinfcom"
                                        filter="RIC_ID,MUS_INTERFCOMAN_ITC_ID,MUS_ROLES_ROL_ID"
                                        titulos="RIC_ID,MUS_INTERFCOMAN_ITC_ID,MUS_ROLES_ROL_ID"
