...
{form name="frmMco_comprasdetaConsult" method="get"}

   {tools_barstandardsp type="Button" reference_id =100 
                        form_name="frmMco_comprasdetaConsult"
                        commands="vc2CmdDefaultMco_comprasdeta,vc2CmdShowByIdMco_comprasdeta,vc2CmdDeleteMco_comprasdeta,default,vc2CmdHelpMco_comprasdeta"
...
<table border=0  cellpadding=0 align="center" class=adminlist width=100%>
	...
	<tr>
		<td>{consult_table_referenciasp type="LIST" 
                                        table_name="mco_comprasdeta"
                                        llaves="CDE_ID"
                                        form_name="frmMco_comprasdetaConsult"
                                        command="vc2CmdShowListMco_comprasdeta"     
                                        command_showbyid="vc2CmdShowByIdMco_comprasdeta"
                                        DataGateway="mco_comprasdeta"
                                        filter="CDE_ID,CDE_CANTIDAD,CDE_PRECIOCOMPR,COP_ID,PDU_ID"
                                        titulos="CDE_ID,CDE_CANTIDAD,CDE_PRECIOCOMPR,COP_ID,PDU_ID"
