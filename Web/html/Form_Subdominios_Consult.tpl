...
{form name="frmSubdominiosConsult" method="get"}

   {tools_barstandardsp type="Button" reference_id =100 
                        form_name="frmSubdominiosConsult"
                        commands="vc2CmdDefaultSubdominios,vc2CmdShowByIdSubdominios,vc2CmdDeleteSubdominios,default,vc2CmdHelpSubdominios"
...
<table border=0  cellpadding=0 align="center" class=adminlist width=100%>
	...
	<tr>
		<td>{consult_table_referenciasp type="LIST" 
                                        table_name="subdominios"
                                        llaves="SUB_ID"
                                        form_name="frmSubdominiosConsult"
                                        command="vc2CmdShowListSubdominios"     
                                        command_showbyid="vc2CmdShowByIdSubdominios"
                                        DataGateway="subdominios"
                                        filter="SUB_ID,DOMINIOS_DOM_ID,SUB_VALOR,SUB_DESCRIPCION,SUB_AUX1,SUB_AUX2"
                                        titulos="SUB_ID,DOMINIOS_DOM_ID,SUB_VALOR,SUB_DESCRIPCION,SUB_AUX1,SUB_AUX2"
