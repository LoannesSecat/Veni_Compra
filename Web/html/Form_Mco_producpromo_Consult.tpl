...
{form name="frmMco_producpromoConsult" method="get"}

   {tools_barstandardsp type="Button" reference_id =100 
                        form_name="frmMco_producpromoConsult"
                        commands="vc2CmdDefaultMco_producpromo,vc2CmdShowByIdMco_producpromo,vc2CmdDeleteMco_producpromo,default,vc2CmdHelpMco_producpromo"
...
<table border=0  cellpadding=0 align="center" class=adminlist width=100%>
	...
	<tr>
		<td>{consult_table_referenciasp type="LIST" 
                                        table_name="mco_producpromo"
                                        llaves="PPM_ID"
                                        form_name="frmMco_producpromoConsult"
                                        command="vc2CmdShowListMco_producpromo"     
                                        command_showbyid="vc2CmdShowByIdMco_producpromo"
                                        DataGateway="mco_producpromo"
                                        filter="PPM_ID,PDU_ID,PPM_FECHAINI,PPM_FECHAFIN,PPM_PRECIOPROM"
                                        titulos="PPM_ID,PDU_ID,PPM_FECHAINI,PPM_FECHAFIN,PPM_PRECIOPROM"
