...
{form name="frmMus_interfcomanConsult" method="get"}

   {tools_barstandardsp type="Button" reference_id =100 
                        form_name="frmMus_interfcomanConsult"
                        commands="vc2CmdDefaultMus_interfcoman,vc2CmdShowByIdMus_interfcoman,vc2CmdDeleteMus_interfcoman,default,vc2CmdHelpMus_interfcoman"
...
<table border=0  cellpadding=0 align="center" class=adminlist width=100%>
	...
	<tr>
		<td>{consult_table_referenciasp type="LIST" 
                                        table_name="mus_interfcoman"
                                        llaves="ITC_ID"
                                        form_name="frmMus_interfcomanConsult"
                                        command="vc2CmdShowListMus_interfcoman"     
                                        command_showbyid="vc2CmdShowByIdMus_interfcoman"
                                        DataGateway="mus_interfcoman"
                                        filter="ITC_ID,MUS_COMANPER_COP_ID,MUS_INTERPERM_INP_ID"
                                        titulos="ITC_ID,MUS_COMANPER_COP_ID,MUS_INTERPERM_INP_ID"
