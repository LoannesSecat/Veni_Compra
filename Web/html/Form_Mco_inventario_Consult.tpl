...
{form name="frmMco_inventarioConsult" method="get"}

   {tools_barstandardsp type="Button" reference_id =100 
                        form_name="frmMco_inventarioConsult"
                        commands="vc2CmdDefaultMco_inventario,vc2CmdShowByIdMco_inventario,vc2CmdDeleteMco_inventario,default,vc2CmdHelpMco_inventario"
...
<table border=0  cellpadding=0 align="center" class=adminlist width=100%>
	...
	<tr>
		<td>{consult_table_referenciasp type="LIST" 
                                        table_name="mco_inventario"
                                        llaves="INV_ID"
                                        form_name="frmMco_inventarioConsult"
                                        command="vc2CmdShowListMco_inventario"     
                                        command_showbyid="vc2CmdShowByIdMco_inventario"
                                        DataGateway="mco_inventario"
                                        filter="INV_ID,INV_NOMBRE"
                                        titulos="INV_ID,INV_NOMBRE"
