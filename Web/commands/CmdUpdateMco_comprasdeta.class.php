...
/**
 * Comando para actualizar un registro de la tabla: mco_comprasdeta
 * @author SpyroFrameWork
 * @copyright Spyro Solutions
 */
class vc2CmdUpdateMco_comprasdeta {
	...
	function execute()
	{
		...
		if(($mco_comprasdeta__CDE_ID != NULL) && ($mco_comprasdeta__CDE_ID != "") && ($mco_comprasdeta__CDE_CANTIDAD != NULL) && ($mco_comprasdeta__CDE_CANTIDAD != "") && ($mco_comprasdeta__CDE_PRECIOCOMPR != NULL) && ($mco_comprasdeta__CDE_PRECIOCOMPR != "") && ($mco_comprasdeta__COP_ID != NULL) && ($mco_comprasdeta__COP_ID != "") && ($mco_comprasdeta__PDU_ID != NULL) && ($mco_comprasdeta__PDU_ID != "")){
			...
			$message = $mco_comprasdeta_manager->updateMco_comprasdeta($mco_comprasdeta__CDE_ID,$mco_comprasdeta__CDE_CANTIDAD,$mco_comprasdeta__CDE_PRECIOCOMPR,$mco_comprasdeta__COP_ID,$mco_comprasdeta__PDU_ID); 
