...
/**
 * Comando para actualizar un registro de la tabla: subdominios
 * @author SpyroFrameWork
 * @copyright Spyro Solutions
 */
class vc2CmdUpdateSubdominios {
	...
	function execute()
	{
		...
		if(($subdominios__SUB_ID != NULL) && ($subdominios__SUB_ID != "") && ($subdominios__DOMINIOS_DOM_ID != NULL) && ($subdominios__DOMINIOS_DOM_ID != "") && ($subdominios__SUB_VALOR != NULL) && ($subdominios__SUB_VALOR != "") && ($subdominios__SUB_DESCRIPCION != NULL) && ($subdominios__SUB_DESCRIPCION != "")){
			...
			$message = $subdominios_manager->updateSubdominios($subdominios__SUB_ID,$subdominios__DOMINIOS_DOM_ID,$subdominios__SUB_VALOR,$subdominios__SUB_DESCRIPCION,$subdominios__SUB_AUX1,$subdominios__SUB_AUX2); 
