...
/**
 * Comando para actualizar un registro de la tabla: mve_facturas
 * @author SpyroFrameWork
 * @copyright Spyro Solutions
 */
class vc2CmdUpdateMve_facturas {
	...
	function execute()
	{
		...
		if(($mve_facturas__FAC_ID != NULL) && ($mve_facturas__FAC_ID != "") && ($mve_facturas__FAC_FECHACOMPRA != NULL) && ($mve_facturas__FAC_FECHACOMPRA != "") && ($mve_facturas__FAC_TOTAL != NULL) && ($mve_facturas__FAC_TOTAL != "") && ($mve_facturas__SUB_TIPOPAGO != NULL) && ($mve_facturas__SUB_TIPOPAGO != "") && ($mve_facturas__USU_ID != NULL) && ($mve_facturas__USU_ID != "")){
			...
			$message = $mve_facturas_manager->updateMve_facturas($mve_facturas__FAC_ID,$mve_facturas__FAC_FECHACOMPRA,$mve_facturas__FAC_TOTAL,$mve_facturas__SUB_TIPOPAGO,$mve_facturas__USU_ID); 
