...
/**
 * Comando para adicionar un registro de la tabla: mus_comanper
 * @author SpyroFrameWork
 * @copyright Spyro Solutions
 */
class CmdAddMus_comanper {
	...
	function execute(){
		...
		if(($mus_comanper__COP_ID != NULL) && ($mus_comanper__COP_ID != "") && ($mus_comanper__COP_NOMBRE != NULL) && ($mus_comanper__COP_NOMBRE != "")){
			...
			$mus_comanper__COP_NOMBRE = $obj_datatype->formatString($mus_comanper__COP_NOMBRE);
			$mus_comanper_manager = Application::getDomainController('Mus_comanperManager'); 
			$message = $mus_comanper_manager->addMus_comanper($mus_comanper__COP_ID,$mus_comanper__COP_NOMBRE); 
