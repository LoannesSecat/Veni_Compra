...
/**
 * Comando para actualizar un registro de la tabla: mus_rolinfcom
 * @author SpyroFrameWork
 * @copyright Spyro Solutions
 */
class vc2CmdUpdateMus_rolinfcom {
	...
	function execute()
	{
		...
		if(($mus_rolinfcom__RIC_ID != NULL) && ($mus_rolinfcom__RIC_ID != "") && ($mus_rolinfcom__MUS_INTERFCOMAN_ITC_ID != NULL) && ($mus_rolinfcom__MUS_INTERFCOMAN_ITC_ID != "") && ($mus_rolinfcom__MUS_ROLES_ROL_ID != NULL) && ($mus_rolinfcom__MUS_ROLES_ROL_ID != "")){
			...
			$message = $mus_rolinfcom_manager->updateMus_rolinfcom($mus_rolinfcom__RIC_ID,$mus_rolinfcom__MUS_INTERFCOMAN_ITC_ID,$mus_rolinfcom__MUS_ROLES_ROL_ID); 
