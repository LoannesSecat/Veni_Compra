...
/**
 * Comando para actualizar un registro de la tabla: mco_inventario
 * @author SpyroFrameWork
 * @copyright Spyro Solutions
 */
class vc2CmdUpdateMco_inventario {
	...
	function execute()
	{
		...
		if(($mco_inventario__INV_ID != NULL) && ($mco_inventario__INV_ID != "") && ($mco_inventario__INV_NOMBRE != NULL) && ($mco_inventario__INV_NOMBRE != "")){
			...
			$message = $mco_inventario_manager->updateMco_inventario($mco_inventario__INV_ID,$mco_inventario__INV_NOMBRE); 
