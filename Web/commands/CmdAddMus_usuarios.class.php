...
/**
 * Comando para adicionar un registro de la tabla: mus_usuarios
 * @author SpyroFrameWork
 * @copyright Spyro Solutions
 */
class CmdAddMus_usuarios {
	...
	function execute(){
		...
		if(($mus_usuarios__USU_ID != NULL) && ($mus_usuarios__USU_ID != "") && ($mus_usuarios__USU_NOMBRE != NULL) && ($mus_usuarios__USU_NOMBRE != "") && ($mus_usuarios__USU_APELLIDO != NULL) && ($mus_usuarios__USU_APELLIDO != "") && ($mus_usuarios__USU_FECHA_NACI != NULL) && ($mus_usuarios__USU_FECHA_NACI != "") && ($mus_usuarios__USU_DIRECCION != NULL) && ($mus_usuarios__USU_DIRECCION != "") && ($mus_usuarios__USU_EMAIL != NULL) && ($mus_usuarios__USU_EMAIL != "") && ($mus_usuarios__USU_CELULAR != NULL) && ($mus_usuarios__USU_CELULAR != "") && ($mus_usuarios__USU_CONTRASENA != NULL) && ($mus_usuarios__USU_CONTRASENA != "") && ($mus_usuarios__SUB_SEXO != NULL) && ($mus_usuarios__SUB_SEXO != "") && ($mus_usuarios__ROL_ID != NULL) && ($mus_usuarios__ROL_ID != "")){
			...
			$mus_usuarios__USU_NOMBRE = $obj_datatype->formatString($mus_usuarios__USU_NOMBRE);
			$mus_usuarios__USU_APELLIDO = $obj_datatype->formatString($mus_usuarios__USU_APELLIDO);
			$mus_usuarios__USU_DIRECCION = $obj_datatype->formatString($mus_usuarios__USU_DIRECCION);
			$mus_usuarios__USU_EMAIL = $obj_datatype->formatString($mus_usuarios__USU_EMAIL);
			$mus_usuarios__USU_CELULAR = $obj_datatype->formatString($mus_usuarios__USU_CELULAR);
			$mus_usuarios__USU_CONTRASENA = $obj_datatype->formatString($mus_usuarios__USU_CONTRASENA);
			...
			$message = $mus_usuarios_manager->addMus_usuarios($mus_usuarios__USU_ID,$mus_usuarios__USU_NOMBRE,$mus_usuarios__USU_APELLIDO,$mus_usuarios__USU_FECHA_NACI,$mus_usuarios__USU_DIRECCION,$mus_usuarios__USU_EMAIL,$mus_usuarios__USU_CELULAR,$mus_usuarios__USU_CONTRASENA,$mus_usuarios__SUB_SEXO,$mus_usuarios__ROL_ID); 
