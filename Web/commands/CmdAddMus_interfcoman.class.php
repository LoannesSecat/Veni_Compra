...
/**
 * Comando para adicionar un registro de la tabla: mus_interfcoman
 * @author SpyroFrameWork
 * @copyright Spyro Solutions
 */
class CmdAddMus_interfcoman {
	...
	function execute(){
		...
		if(($mus_interfcoman__ITC_ID != NULL) && ($mus_interfcoman__ITC_ID != "") && ($mus_interfcoman__MUS_COMANPER_COP_ID != NULL) && ($mus_interfcoman__MUS_COMANPER_COP_ID != "") && ($mus_interfcoman__MUS_INTERPERM_INP_ID != NULL) && ($mus_interfcoman__MUS_INTERPERM_INP_ID != "")){
			...
			$message = $mus_interfcoman_manager->addMus_interfcoman($mus_interfcoman__ITC_ID,$mus_interfcoman__MUS_COMANPER_COP_ID,$mus_interfcoman__MUS_INTERPERM_INP_ID); 
