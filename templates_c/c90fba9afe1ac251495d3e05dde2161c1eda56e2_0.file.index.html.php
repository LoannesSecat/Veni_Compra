<?php
/* Smarty version 3.1.30, created on 2018-11-03 22:55:26
  from "C:\xampp\htdocs\LitlePHP\applications\veni_compra\web\html\index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5bde194ea596b2_02560729',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c90fba9afe1ac251495d3e05dde2161c1eda56e2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\LitlePHP\\applications\\veni_compra\\web\\html\\index.html',
      1 => 1541282107,
      2 => 'file',
    ),
  ),
...
function content_5bde194ea596b2_02560729 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
    ...
    <ul class="slides blue">
      <li>
        <a href="promociones.html">
          <img src="web/images/carousel/slider-0.jpg" class="img-responsive" alt="">
        </a>
      ...
      <li>
        <a href="promociones.html">
          <img src="web/images/carousel/slider-1.jpg" class="responsive-img" alt="">
        </a>
      ...
      <li>
        <a href="promociones.html">
          <img src="web/images/carousel/slider-2.jpg" class="responsive-img" alt="">
        </a>
    ...
    <div class="row">
      ...
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/images/card/shirt-2.jpeg" alt="">
              <div class="overlay">
                <div class="botones">
                  <a href="producto.html" class="fa"><i class="material-icons white-text">favorite</i></a>
                  <a href="producto.html" class="fa"><i class="material-icons white-text">forward</i></a>
      ...
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/images/card/ryzen.png" alt="">
              <div class="overlay">
                <div class="botones">
                  <a href="producto.html" class="fa"><i class="material-icons white-text">favorite</i></a>
                  <a href="producto.html" class="fa"><i class="material-icons white-text">forward</i></a>
      ...
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/images/card/ball.jpg" alt="">
              <div class="overlay">
                <div class="botones">
                  <a href="producto.html" class="fa"><i class="material-icons white-text">favorite</i></a>
                  <a href="producto.html" class="fa"><i class="material-icons white-text">forward</i></a>
      ...
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/images/card/tv.jpg" alt="">
              <div class="overlay">
                <div class="botones">
                  <a href="producto.html" class="fa"><i class="material-icons white-text">favorite</i></a>
                  <a href="producto.html" class="fa"><i class="material-icons white-text">forward</i></a>
      ...
      <div class="col s12 m6 l4">
        <div class="card hoverable">
          <div class="card-image waves-effect waves-block waves-light">
            <div class="boton">
              <img src="web/images/card/xbox.jpg" alt="">
              <div class="overlay">
                <div class="botones">
                  <a href="producto.html" class="fa"><i class="material-icons white-text">favorite</i></a>
                  <a href="producto.html" class="fa"><i class="material-icons white-text">forward</i></a>
    ...
    <div class="row">
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/images/categorias/camera.svg" alt="">
            </div>
            <div class="content">
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/images/categorias/pc.svg" alt="">
            </div>
            <div class="content">
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/images/categorias/gamepad.svg" alt="">
            </div>
            <div class="content">
              <span>Juegos</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/images/categorias/running.svg" alt="">
            </div>
            <div class="content">
              <span>Fitness</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/images/categorias/animal-paw-print.svg" alt="">
            </div>
            <div class="content">
              <span>Mascotas</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/images/categorias/engineer.svg" alt="">
            </div>
            <div class="content">
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/images/categorias/robotic.svg" alt="">
            </div>
            <div class="content">
              <span>Juguetes</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/images/categorias/makeup.svg" alt="">
            </div>
            <div class="content">
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/images/categorias/laundry.svg" alt="">
            </div>
            <div class="content">
              <span>Ropa</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            <div class="image">
              <img src="web/images/categorias/headphones.svg" alt="">
            </div>
            <div class="content">
              <span>Musica</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <a href="resultados.html">
          <div class="category hoverable">
            ...
            <div class="image">
              <img src="web/images/categorias/avengers.svg" alt="">
            </div>
            <div class="content">
              <span>Comics</span>
            </div>
      ...
      <div class="col s6 m4 l2">
        <div class="category hoverable">
          <div class="image">
            <img src="web/images/categorias/vegetables.svg" alt="">
          </div>
          <div class="content">
            <span>Comida</span>
          </div>
